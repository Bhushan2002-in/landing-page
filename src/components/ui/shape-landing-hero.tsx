...
function HeroGeometric({
  badge = "Trusted by Gold Coast founders",
  title1 = "Master Your Business Strategy",
  title2 = "and Unlock Higher Profits",
}: {
  badge?: string;
  title1?: string;
  title2?: string;
      ...
      <div className="relative z-10 container mx-auto px-4 md:px-6">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <motion.div custom={2} variants={fadeUpVariants} initial="hidden" animate="visible">
            <p className="text-base sm:text-lg md:text-xl text-white/40 mb-6 leading-relaxed font-light tracking-wide max-w-xl mx-auto px-4">
              Come learn the 5 key drivers that increase your PROFITS and which are the ones YOU need to be working on!
            </p>
          </motion.div>

          <motion.div custom={3} variants={fadeUpVariants} initial="hidden" animate="visible" className="flex justify-center">
            <FeyButton aria-label="Register Now">Register Now</FeyButton>
          </motion.div>
        </div>
      </div>
